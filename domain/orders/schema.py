...
class OrderCreate(BaseModel):
    ...
    def validate_financials(self):
        if not (len(self.lengths) == len(self.widths) == len(self.prices_per_m2) == len(self.factory_prices_per_m2)):
